...
def get_quote_by_mood():
    hard_code_list = [{'quote': 'The Paradoxical CommandmentsPeople are illogical, unreasonable, and self-centered. Love them anyway. If you do good, people will accuse you of selfish ulterior motives. Do good anyway. If you are successful, you will win false friends and true enemies. Succeed anyway. The good you do today will be forgotten tomorrow. Do good anyway. Honesty and frankness make you vulnerable. Be honest and frank anyway. The biggest men and women with the biggest ideas can be shot down by the smallest men and women with the smallest minds. Think big anyway. People favor underdogs but follow only top dogs. Fight for a few underdogs anyway. What you spend years building may be destroyed overnight. Build anyway. People really need help but may attack you if you do help them. Help people anyway. Give the world the best you have and youll get kicked in the teeth. Give the world the best you have anyway.', 'author': 'Kent M. Keith'},
                      ...
                      {'quote': 'Its so hard to forget pain, but its even harder to remember sweetness. We have no scar to show for happiness. We learn so little from peace.', 'author': 'Chuck Palahniuk'},
                      ...
                      {'quote': 'Happiness is when what you think, what you say, and what you do are in harmony.', 'author': 'Mahatma Gandhi'}, {'quote': 'Every man has his secret sorrows which the world knows not; and often times we call a man cold when he is only sad.', 'author': 'Henry Wadsworth Longfellow'},
                      {'quote': 'Theres nothing like deep breaths after laughing that hard. Nothing in the world like a sore stomach for the right reasons.', 'author': 'Stephen Chbosky'},
                      ...
                      {'quote': 'Take responsibility of your own happiness, never put it in other people’s hands.', 'author': 'Roy T. Bennett'},
                      {'quote': 'The most important thing is to enjoy your life—to be happy—its all that matters.', 'author': 'Audrey Hepburn'},
                      {'quote': 'Happiness is a warm puppy.', 'author': 'Charles M. Schulz'}, {'quote': 'You cannot protect yourself from sadness without protecting yourself from happiness.', 'author': 'Jonathan Safran Foer'},
                      {'quote': 'Don’t waste your time in anger, regrets, worries, and grudges. Life is too short to be unhappy.', 'author': 'Roy T. Bennett'},
                      {'quote': 'It isnt what you have or who you are or where you are or what you are doing that makes you happy or unhappy. It is what you think about it.', 'author': 'Dale Carnegie'},
                      {'quote': 'Even if you cannot change all the people around you, you can change the people you choose to be around. Life is too short to waste your time on people who don’t respect, appreciate, and value you. Spend your life with people who make you smile, laugh, and feel loved.', 'author': 'Roy T. Bennett'},
                      {'quote': 'No medicine cures what happiness cannot.', 'author': 'Gabriel GarcíA MáRquez'}, {'quote': 'Happiness is having a large, loving, caring, close-knit family in another city.', 'author': 'George Burns'},
                      ...
                      {'quote': 'If you want to be happy, do not dwell in the past, do not worry about the future, focus on living fully in the present.', 'author': 'Roy T. Bennett'},
                      {'quote': 'I felt my lungs inflate with the onrush of scenery—air, mountains, trees, people. I thought, "This is what it is to be happy.', 'author': 'Sylvia Plath'}]
