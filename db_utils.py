...
from sqlalchemy import create_engine, MetaData, Table, Column, String, Integer, ForeignKey, Date
...
engine = create_engine('mysql+mysqlconnector://root:Cl34nbr34k!@localhost/mood_tracker10', echo=True)
